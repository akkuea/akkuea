...
export function AuditLogViewer({ operatorWallet, isWalletConnected }: AuditLogViewerProps) {
  ...
  const fetchLogs = useCallback(async () => {
    ...
    try {
      ...
      if (debouncedActionType) searchParams.set("actionType", debouncedActionType);
      
      const res = await fetch(`/api/v1/admin/audit-log?${searchParams.toString()}`, {
        headers: {
