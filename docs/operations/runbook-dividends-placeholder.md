...
Presentation version of the target design from `docs/strategy/product-brief.md#sequence-monthly-income-distribution-cycle` (vertical, generated by [`scripts/diagrams/`](../../scripts/diagrams/)):

![Monthly Income Distribution Cycle](../diagrams/02-payout-cycle-vertical.svg)
